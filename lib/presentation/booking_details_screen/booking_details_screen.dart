                                ...
                                children: [
                                  CustomIconButton(
                                      ...
                                      child: CustomImageView(
                                          svgPath:
                                              ImageConstant.imgCloseGray40001)),
                                  Align(
                                      alignment: Alignment.bottomRight,
                                      child: Padding(
                                          padding:
                                              getPadding(right: 37, bottom: 21),
                                          child: Row(
                                              mainAxisAlignment:
                                                                ...
                                                                children: [
                                                                  SizedBox(
                                                                      ...
                                                                      child: Stack(
                                                                          ...
                                                                          children: [
                                                                            CustomImageView(
                                                                                imagePath: ImageConstant.imgOval250x50,
                                                                                height: getSize(50),
                                                                                width: getSize(50),
                                                                      ...
                                                                      child: Stack(
                                                                          ...
                                                                          children: [
                                                                            CustomImageView(
                                                                                ...
                                                                                margin: getMargin(left: 2, bottom: 4)),
                                                                            Align(
                                                                                alignment: Alignment.topCenter,
                                                                                child: Text("Amadou Faye", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.titleMedium)),
                                                                            Align(
                                                                                alignment: Alignment.bottomLeft,
                                                                                child: Padding(padding: getPadding(left: 23), child: Text("4.9", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.bodyMedium)))
                                                                          ])),
                                                                  Spacer(),
                                                                  CustomIconButton(
                                                                      height:
