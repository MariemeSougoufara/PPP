...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapSignUpTabContainer(context);
                                            },
                                            child: Container(
                                                decoration: AppDecoration.fill1,
                                                child: Column(
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapSignInTabContainer(context);
                                            },
                                            child: Container(
                                                decoration: AppDecoration.fill1,
                                                child: Column(
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapChooseVehicletype(context);
                                            },
                                            child: Container(
                                                decoration: AppDecoration.fill1,
                                                child: Column(
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapChooseVehicletypeFullview(
                                                  context);
                                            },
                                            child: Container(
                                                decoration: AppDecoration.fill1,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapSelectConforttype(context);
                                            },
                                            child: Container(
                                                decoration: AppDecoration.fill1,
                                                child: Column(
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapBookingSuccessfully(context);
                                            },
                                            child: Container(
                                                decoration: AppDecoration.fill1,
                                                child: Column(
  ...
  /// Navigates to the splashScreensScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the splashScreensScreen.
  onTapSplashScreens(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.splashScreensScreen);
  }
  ...
  onTapSignUpTabContainer(BuildContext context) {
  ...
  onTapSignInTabContainer(BuildContext context) {
  ...
  onTapChooseDropoff(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.chooseDropOffScreen);
  }

  /// Navigates to the chooseDropOffWithMapScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the chooseDropOffWithMapScreen.
  onTapChooseDropoffwithmap(BuildContext context) {
  ...
  onTapChooseVehicletype(BuildContext context) {
  ...
  onTapChooseVehicletypeFullview(BuildContext context) {
  ...
  onTapSelectConforttype(BuildContext context) {
  ...
  onTapInputPromoCode(BuildContext context) {
  ...
  onTapSelectDriver(BuildContext context) {
  ...
  onTapBookingSuccessfully(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.bookingSuccessfullyScreen);
  }

  /// Navigates to the myHistoryScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the myHistoryScreen.
  onTapMyHistory(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.myHistoryScreen);
  }
  ...
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the bookingDetailsScreen.
  onTapBookingDetails(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.bookingDetailsScreen);
  }
  ...
  /// Navigates to the inviteFriendsOneScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the inviteFriendsOneScreen.
  onTapInviteFriendsOne(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.inviteFriendsOneScreen);
  }
  ...
  onTapMyAccountSelectBirthday(BuildContext context) {
