                                                              ...
                                                              child: Container(
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                            padding:
                                                                                getPadding(top: 11, right: 4),
                                                                            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                              CustomImageView(svgPath: ImageConstant.imgCarOnprimary28x61, height: getVerticalSize(28), width: getHorizontalSize(61), radius: BorderRadius.only(topLeft: Radius.circular(getHorizontalSize(16)), topRight: Radius.circular(getHorizontalSize(16))), margin: getMargin(top: 6, bottom: 8)),
                                                                              Padding(
