...
class BookingSuccessfullyScreen extends StatelessWidget {
  const BookingSuccessfullyScreen({Key? key}) : super(key: key);
                        ...
                        child: Stack(alignment: Alignment.center, children: [
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                              ...
                                                                              child: Container(
                                                                                  ...
                                                                                  padding: getPadding(left: 15, top: 9, right: 15, bottom: 9),
                                                                                  decoration: AppDecoration.fill5.copyWith(borderRadius: BorderRadiusStyle.customBorderTL8),
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                    ...
                                                                                    Container(
                                                                                        ...
                                                                                        child: Stack(alignment: Alignment.topCenter, children: [
                                                                                          ...
                                                                                          Align(alignment: Alignment.topCenter, child: Text("Abdou Faye", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.titleMedium)),
                                                                          ...
                                                                          Align(
                                                                              ...
                                                                              child: SizedBox(width: getHorizontalSize(341), child: Divider(height: getVerticalSize(2), thickness: getVerticalSize(2), color: appTheme.blueGray5001)))
                                                                        ])),
                                                                Align(
                                                                    alignment:
                                                                        Alignment
                                                                            .centerLeft,
                                                                    child: Padding(
                                                                        padding: getPadding(left: 15, top: 24, right: 85),
                                                                        child: Row(children: [
                                                                          CustomImageView(
                                                                              imagePath: ImageConstant.imgOval230x30,
                                                                              height: getSize(30),
                                                                              width: getSize(30),
                                                                              radius: BorderRadius.circular(getHorizontalSize(15))),
                                                                          CustomImageView(
                                                                              imagePath: ImageConstant.imgOval21,
                                                                              height: getSize(30),
                                                                              width: getSize(30),
                                                                              radius: BorderRadius.circular(getHorizontalSize(15)),
                                                                              margin: getMargin(left: 5)),
                                                                          CustomImageView(
                                                                              imagePath: ImageConstant.imgOval22,
                                                                              height: getSize(30),
                                                                              width: getSize(30),
                                                                              radius: BorderRadius.circular(getHorizontalSize(15)),
                                                                              margin: getMargin(left: 5)),
                                                                          Padding(
                                                                              padding: getPadding(left: 7, top: 6, bottom: 4),
                                                                              child: Text("25 Recommendations", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: TextThemeHelper.bodyMediumOnSecondaryContainer))
                                                                        ]))),
                                                                Padding(
                                                                    padding:
                                                                        getPadding(
                                                                          ...
                                                                          Padding(
                                                                              ...
                                                                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                Padding(
                                                                                    ...
                                                                                    child: Row(children: [
                                                                                      Text("Distance".toUpperCase(), overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.labelLarge),
                                                                                      Padding(padding: getPadding(left: 34), child: Text("TEMPS".toUpperCase(), overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.labelLarge)),
                                                                                      Padding(padding: getPadding(left: 43), child: Text("PRIX".toUpperCase(), overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.labelLarge))
                                                                                    ])),
                                                                                Padding(
                                                                                    padding: getPadding(left: 6, top: 7),
                                                                                    child: Row(children: [
                                                                                      Text("0.4 km", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.titleSmall),
                                                                                      Padding(padding: getPadding(left: 40), child: Text("3 min", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.titleSmall)),
                                                                                      Padding(padding: getPadding(left: 23), child: Text("9500 FCFA", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: theme.textTheme.titleSmall))
                                                                                    ]))
                                                                              ]))
                                                                        ])),
                          ...
                          Align(
                              ...
                              child: Container(
                                  ...
                                  child: Container(
                                      margin: getMargin(left: 3, bottom: 137),
                                                                    ...
                                                                    GestureDetector(
                                                                        ...
                                                                        child: Text(
                                                                            ...
                                                                            overflow:
                                                                                TextOverflow.ellipsis,
                                                                            textAlign: TextAlign.left,
                                                                            style: TextThemeHelper.titleMediumGray400)),
                                                                    GestureDetector(
                                                                        onTap:
                                                                            () {
                                                                          onTapTxtDone(
